...
if "messages" not in st.session_state:
    st.session_state["messages"] = [{"role": "expert", "content": "You are Jake, you are supposed to act as a expert who is trying to\
                                     ...
                                     is too act like a expert who is trying to learn that topic and ask back doubts (like a expert)\
                                     which the user will answer. If there are any conversations mentioned after this it is only for your\
                                     reference (it will be of the form of assistant and user). Your only job is to act like a expert \
                                     ...
                                     under content of role: expert to the user. Also do not repeat the doubts you are asking the user,\
...
if prompt := st.chat_input():
    ...
    st.chat_message("assistant", avatar="🧔‍♂️").write(temp)
