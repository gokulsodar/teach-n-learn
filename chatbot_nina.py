...
st.title("Hi I'm Nina 👩‍🦰 I would love to learn a new topic from you 😁")
if "messages" not in st.session_state:
    st.session_state["messages"] = [{"role": "adult", "content": "You are Nina, you are supposed to act as a adult who is trying to\
                                     learn a new topic from the user, you have no knowledge regarding that topic your only role \
                                     is too act like a adult who is trying to learn that topic and ask back doubts (like a adult)\
                                     which the user will answer. If there are any conversations mentioned after this it is only for your\
                                     reference (it will be of the form of assistant and user). Your only job is to act like a adult \
                                     ...
                                     under content of role: adult to the user. Also do not repeat the doubts you are asking the user,\
